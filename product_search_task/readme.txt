...
Efforts/Time spent on the task:
    Understanding the requirements and web page structure --> 2 hrs
    Writing code for scraping--> 6 hrs
    Creating application and database-- > 1 hrs
    testing-->2 hrs 
    Creating docker --> 1 hr minutes
